...
- the recorded worker provider/model when the runtime resolves them, and a requirement to preserve that exact route across every worker-driven follow-up;
...
python <SCRIPT> record-worker --state-file <STATE> --worker-id <WORKER_ID> --worker-profile <WORKER_PROFILE> --worker-provider <WORKER_PROVIDER> --worker-model <WORKER_MODEL> --continuity worker_identity_profile
python <SCRIPT> start-implementation --state-file <STATE> --worker-id <WORKER_ID> --worker-profile <WORKER_PROFILE> --worker-provider <WORKER_PROVIDER> --worker-model <WORKER_MODEL>
python <SCRIPT> start-review --state-file <STATE> --reviewer-id <REVIEWER_ID> --reviewer-profile <REVIEWER_PROFILE>
...
python <SCRIPT> record-fix --state-file <STATE> --worker-id <WORKER_ID> --worker-profile <WORKER_PROFILE> --worker-provider <WORKER_PROVIDER> --worker-model <WORKER_MODEL> --report <REPORT> --validation <TEST_EVIDENCE>
...
python <SCRIPT> record-remote-assessment --state-file <STATE> --worker-id <WORKER_ID> --worker-profile <WORKER_PROFILE> --worker-provider <WORKER_PROVIDER> --worker-model <WORKER_MODEL> --outcome clean|changes|blocked --report <REPORT>
python <SCRIPT> resolve-blocked --state-file <STATE> --decision merge|changes --evidence <USER_OR_CONTROLLER_DECISION>
python <SCRIPT> record-remote-fix --state-file <STATE> --worker-id <WORKER_ID> --worker-profile <WORKER_PROFILE> --worker-provider <WORKER_PROVIDER> --worker-model <WORKER_MODEL> --head-sha <NEW_SHA> --validation <TEST_EVIDENCE>
python <SCRIPT> record-check-repair --state-file <STATE> --worker-id <WORKER_ID> --worker-profile <WORKER_PROFILE> --worker-provider <WORKER_PROVIDER> --worker-model <WORKER_MODEL> --head-sha <NEW_SHA> --validation <TEST_EVIDENCE> --evidence <CHECK_REPAIR_EVIDENCE>
